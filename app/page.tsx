...
export default function Page() {
  ...
  // NOTE: using string concatenation (no backticks) to avoid shell/template issues
          ...
          <div className="glow-card p-4 rounded-2xl border border-white/10 bg-white/5 space-y-3">
            ...
            <ul className="text-sm text-white/80 space-y-2">
              ...
              <li className="text-white/70">
                <span className="font-semibold">Staking —</span> Soft-stake (no lock). Sign once here.
              </li>
            </ul>
